                        ...
                        <div class="card shadow mb-4">
                            ...
                            <div class="card-body">
                                <div class="text-center">
                                    <img class="img-fluid px-3 px-sm-4 mt-3 mb-4" style="width: 25rem;" src="public/template/img/undraw_posting_photo.svg" alt="">
                                </div>
    ...
    <div class="modal-dialog" role="document">
        <div class="modal-content">
            ...
            <div class="modal-footer">
                ...
                <a class="btn btn-primary" href="public/template/login.html">Logout</a>
            </div>
        </div>
    </div>
</div>
